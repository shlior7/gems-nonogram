...
// import { makePuzzle } from '../services/sudokuCreator';
...
// export const backGroundBlue = '#1B6B9B';
// export const backGroundGreen = '#7CDC1B';
...
//     const rows = this.state. .getIn(['choices', 'rows']);
